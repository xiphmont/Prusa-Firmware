...
const char MSG_PLA_PREHEAT[] PROGMEM_N1 = ("PLA  -  " STRINGIFY(PLA_PREHEAT_HOTEND_TEMP) "/" STRINGIFY(PLA_PREHEAT_HPB_TEMP)); ////
const char MSG_PET_PREHEAT[] PROGMEM_N1 = ("PET  -  " STRINGIFY(PET_PREHEAT_HOTEND_TEMP) "/" STRINGIFY(PET_PREHEAT_HPB_TEMP)); ////
const char MSG_ASA_PREHEAT[] PROGMEM_N1 = ("ASA  -  " STRINGIFY(ASA_PREHEAT_HOTEND_TEMP) "/" STRINGIFY(ASA_PREHEAT_HPB_TEMP)); ////
const char MSG_ABS_PREHEAT[] PROGMEM_N1 = ("ABS  -  " STRINGIFY(ABS_PREHEAT_HOTEND_TEMP) "/" STRINGIFY(ABS_PREHEAT_HPB_TEMP)); ////
const char MSG_HIPS_PREHEAT[] PROGMEM_N1 = ("HIPS -  " STRINGIFY(HIPS_PREHEAT_HOTEND_TEMP) "/" STRINGIFY(HIPS_PREHEAT_HPB_TEMP)); ////
const char MSG_PP_PREHEAT[] PROGMEM_N1 = ("PP   -  " STRINGIFY(PP_PREHEAT_HOTEND_TEMP) "/" STRINGIFY(PP_PREHEAT_HPB_TEMP)); ////
const char MSG_FLEX_PREHEAT[] PROGMEM_N1 = ("FLEX -  " STRINGIFY(FLEX_PREHEAT_HOTEND_TEMP) "/" STRINGIFY(FLEX_PREHEAT_HPB_TEMP)); ////
